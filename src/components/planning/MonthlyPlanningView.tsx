  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-white flex items-center gap-3">
            ...
            <span className="text-[11px] px-2.5 py-0.5 rounded-full bg-[#1c2333] text-[#cbd5e1] border border-[#2b364e] font-bold">
              30-Day Math
            </span>
          </h1>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/medicines/new"
            className="inline-flex items-center gap-2 px-5 py-2.5 text-[14px] font-semibold text-white bg-[#ff385c] hover:bg-[#e00b41] rounded-full shadow-md shadow-[#ff385c]/30 transition-all"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {/* Apollo 24|7 */}
        <div className="bg-[#131722] border border-[#1e2536] rounded-3xl p-6 shadow-xl flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-mono text-[#94a3b8] px-2.5 py-0.5 rounded-full bg-[#0e121a] border border-[#1b2130]">
                7–10d Lead
              </span>
            </div>
            ...
            <div className="my-4 p-4 rounded-2xl bg-[#0e121a] border border-[#1b2130] flex items-center justify-between">
          ...
          <div className="text-[11px] text-[#94a3b8] bg-[#0e121a] p-3 rounded-xl border border-[#1b2130]">
      ...
      <div className="bg-[#131722] border border-[#1e2536] rounded-3xl p-6 sm:p-8 shadow-xl overflow-hidden">
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-full text-xs font-semibold transition-colors ${
                vendorFilter === "all"
                  ...
                  : "bg-[#0e121a] text-[#94a3b8] hover:text-white border border-[#1e2536]"
              }`}
            >
              ...
              {filteredMedicines.map((item) => {
                ...
                return (
                  <tr
                    ...
                    className="hover:bg-[#181f2e] transition-colors group"
                  >
                    {/* Name */}
                    <td className="py-4 px-4">
                      ...
                      >
                        ...
                        {item.medicine.strength && (
                          <span className="text-[11px] px-1.5 py-0.5 rounded-full bg-[#1c2333] text-[#cbd5e1] font-mono border border-[#2b364e]">
                            {item.medicine.strength}
                          </span>
                        )}
                      </Link>
                    ...
                    <td className="py-4 px-3 text-center">
                      <span className="px-3 py-1 rounded-full bg-[#1c2333] text-white border border-[#2b364e] font-mono font-bold text-xs">
                    ...
                    <td className="py-4 px-4 text-center">
                      <span className="px-2.5 py-0.5 rounded-full text-[11px] font-semibold border capitalize bg-[#0e121a] text-[#cbd5e1] border-[#1b2130]">
                    ...
                    <td className="py-4 px-4 text-right">
                      <button
                        ...
                        className="px-4 py-2 bg-[#ff385c] hover:bg-[#e00b41] active:scale-98 text-white font-semibold rounded-full text-xs transition-all shadow-md shadow-[#ff385c]/25"
                      >
                        Order Now
                      </button>
                    </td>
