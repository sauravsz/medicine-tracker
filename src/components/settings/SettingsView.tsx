  ...
  return (
    <form onSubmit={handleSave} className="space-y-8 max-w-4xl mx-auto pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#222222] flex items-center gap-3">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white bg-[#ff385c] hover:bg-[#e00b41] active:scale-98 rounded-full shadow-md transition-all disabled:opacity-50"
        >
      ...
      <section className="bg-white border border-[#ebebeb] rounded-3xl p-6 sm:p-8 shadow-[0_1px_3px_rgba(0,0,0,0.05)] space-y-6">
        <div className="flex items-center gap-3 pb-4 border-b border-[#ebebeb]">
          ...
          <div>
            <h2 className="text-lg font-bold text-[#222222]">Default Channel Delivery Windows</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* Apollo */}
          <div className="p-4 rounded-2xl bg-[#f7f7f7] border border-[#ebebeb] space-y-3">
            <span className="font-bold text-xs text-[#222222] block">Apollo 24|7 (Online)</span>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                <label className="text-[10px] font-bold text-[#6a6a6a] block mb-1">Min Days</label>
                <input
                  type="number"
                  min="0"
                  ...
                  className="w-full bg-white border border-[#dddddd] rounded-xl px-2.5 py-1.5 text-[#222222] font-mono"
                />
              </div>
              <div>
                <label className="text-[10px] font-bold text-[#6a6a6a] block mb-1">Max Days</label>
                <input
                  type="number"
                  min="1"
            ...
            <p className="text-[11px] text-[#6a6a6a]">Default: 7–10 days</p>
          </div>

          {/* Mr. Med */}
          <div className="p-4 rounded-2xl bg-[#f7f7f7] border border-[#ebebeb] space-y-3">
            <span className="font-bold text-xs text-[#222222] block">Mr. Med (Online)</span>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                <label className="text-[10px] font-bold text-[#6a6a6a] block mb-1">Min Days</label>
                <input
            ...
            <p className="text-[11px] text-[#6a6a6a]">Default: 3–5 days</p>
          </div>

          {/* Offline Store */}
          <div className="p-4 rounded-2xl bg-[#f7f7f7] border border-[#ebebeb] space-y-3">
            <span className="font-bold text-xs text-[#222222] block">Offline Local Store</span>
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                <label className="text-[10px] font-bold text-[#6a6a6a] block mb-1">Min Days</label>
                <input
            ...
            <p className="text-[11px] text-[#6a6a6a]">Default: 0–1 days</p>
          </div>
        </div>

        {/* Global Safety Buffer */}
        <div className="p-4 rounded-2xl bg-[#f7f7f7] border border-[#ebebeb] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <span className="text-xs font-bold text-[#222222] block">Global Safety Buffer (Days)</span>
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="w-20 bg-white border border-[#dddddd] rounded-xl px-3 py-1.5 text-sm text-[#222222] font-mono text-center font-bold"
            />
            <span className="text-xs text-[#6a6a6a] font-mono">days</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white border border-[#ebebeb] rounded-3xl p-6 sm:p-8 shadow-[0_1px_3px_rgba(0,0,0,0.05)] space-y-6">
        <div className="flex items-center gap-3 pb-4 border-b border-[#ebebeb]">
          ...
          <div>
            <h2 className="text-lg font-bold text-[#222222]">Automated Daily Reorder Digest</h2>
            <p className="text-[13px] text-[#6a6a6a]">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 rounded-2xl bg-[#f7f7f7] border border-[#ebebeb]">
            <div>
              <span className="text-xs font-bold text-[#222222] block">Enable Daily Reorder Digest</span>
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                settings.reminders_enabled ? "bg-[#ff385c]" : "bg-[#dddddd]"
              }`}
            >
              <span
          ...
          {/* Test Trigger */}
          <div className="p-4 rounded-2xl bg-[#f7f7f7] border border-[#ebebeb] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div>
              <span className="text-xs font-bold text-[#222222] block">Test Cron Route</span>
              <span className="text-[12px] text-[#6a6a6a]">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-[#222222] bg-white hover:bg-[#ebebeb] border border-[#dddddd] rounded-full transition-colors"
            >
          ...
          {testCronResult && (
            <div className="p-3.5 rounded-xl bg-[#f7f7f7] border border-[#ebebeb] text-xs font-mono text-[#222222]">
              {testCronResult}
            </div>
          )}
        </div>
      ...
      <section className="bg-white border border-[#ebebeb] rounded-3xl p-6 sm:p-8 shadow-[0_1px_3px_rgba(0,0,0,0.05)] space-y-6">
        <div className="flex items-center justify-between pb-4 border-b border-[#ebebeb]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-[#222222]">Database & Supabase Deployment</h2>
              <p className="text-[13px] text-[#6a6a6a]">
          ...
          >
            {copiedSql ? <Check className="h-3.5 w-3.5 text-[#16a34a]" /> : <Copy className="h-3.5 w-3.5 text-[#6a6a6a]" />}
        ...
        <div className="space-y-3">
          ...
          <div className="relative rounded-2xl bg-[#f7f7f7] border border-[#ebebeb] p-4 font-mono text-[11px] text-[#222222] max-h-60 overflow-y-auto">
            <pre>{sqlSchema}</pre>
          </div>
        </div>
      </section>
